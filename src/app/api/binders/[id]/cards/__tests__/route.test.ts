...
describe('POST /api/binders/[id]/cards', () => {
  ...
  it('成功：空格位優先填入', async () => {
    ...
    const emptySlot1 = { id: 'slot1', binderId: 'b1', cardId: null, displayCardId: null, status: null, pageNumber: 1, slotIndex: 0, createdAt: new Date(), groupId: null, groupIndex: null, labels: [] }
    const emptySlot2 = { id: 'slot2', binderId: 'b1', cardId: null, displayCardId: null, status: null, pageNumber: 1, slotIndex: 1, createdAt: new Date(), groupId: null, groupIndex: null, labels: [] }
  ...
  it('成功：不足才新增頁', async () => {
    ...
    const emptySlot = { id: 'slot1', binderId: 'b1', cardId: null, displayCardId: null, status: null, pageNumber: 1, slotIndex: 0, createdAt: new Date(), groupId: null, groupIndex: null, labels: [] }
