        ...
        <form onSubmit={onSubmit}>
          <FieldGroup>
            ...
            <Field className="grid grid-cols-2 gap-4">
              <Button variant="outline" size="lg" type="button" className="bg-surface-container hover:bg-surface-container-highest" onClick={() => signIn('google')}>
              ...
              <Button variant="outline" size="lg" type="button" className="bg-surface-container hover:bg-surface-container-highest" onClick={() => signIn('discord')}>
