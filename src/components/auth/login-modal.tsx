        ...
        <form onSubmit={handleSubmit}>
          <FieldGroup>
            ...
            <Field className="grid grid-cols-2 gap-4">
              <Button variant="outline" type="button" className="h-10 bg-surface-container hover:bg-surface-container-highest" onClick={() => signIn('google')}>
              ...
              <Button variant="outline" type="button" className="h-10 bg-surface-container hover:bg-surface-container-highest" onClick={() => signIn('discord')}>
