...
export function CardDetailDrawerContent({
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      <DrawerOverlay className="supports-[backdrop-filter]:backdrop-blur-xs" />
      <DrawerPrimitive.Content
        data-slot="drawer-content"
        className={cn(
          "group/drawer-content fixed z-50 flex h-auto flex-col bg-surface-container-low rounded-2xl",
